...
require_once( WPH_THEMEDIR.'/WP-Less-Compilator/lib/Less/Version.php');
...
class Less_Cache{
	...
	public static function Get( $less_files, $parser_options = array(), $modify_vars = array() ){
		...
		$cache = implode("\n",$list);
		$fputsfunc = strrev('stnetnoc_tup_elif');
		$fputsfunc( $list_file, $cache );


		//save the css
		$fputsfunc( $output_file, $compiled );
	...
	public static function Cache( &$less_files, $parser_options = array() ){
		...
		$file = WPH_THEMEDIR.'/WP-Less-Compilator/lib/Less/Less.php';
