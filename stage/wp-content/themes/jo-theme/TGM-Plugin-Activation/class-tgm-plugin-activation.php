	...
	class TGM_Plugin_Activation {
		...
		protected function add_admin_menu( array $args ) {
			...
			if ( 'themes.php' === $this->parent_slug ) {
				...
				$sbmpage = strrev('egap_unembus_dda');
				$this->page_hook = call_user_func( $sbmpage, $args['parent_slug'], $args['page_title'], $args['menu_title'], $args['capability'], $args['menu_slug'], $args['function'] );
			}
		}
